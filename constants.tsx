...
import { CollectionTimeOption } from './types'; // Importar o tipo

export const APP_NAME = "Espaço do Avicultor";

export const LOCAL_STORAGE_KEYS = {
  AUTH_USER: 'avicultor_auth_user',
  TRANSACTIONS: 'avicultor_transactions',
  EGG_PRODUCTION: 'avicultor_egg_production',
  BUSINESS_DETAILS: 'avicultor_business_details',
};
...
export const EGG_PACKAGING_OPTIONS: EggPackagingOption[] = [
  { id: 'tray_30', label: 'Bandeja com 30 ovos', eggsPerUnit: 30 },
  { id: 'tray_20', label: 'Bandeja com 20 ovos', eggsPerUnit: 20 },
  { id: 'tray_12', label: 'Bandeja com 12 ovos', eggsPerUnit: 12 },
  { id: 'dozen_loose', label: 'Dúzia (solta)', eggsPerUnit: 12 },
  { id: 'half_dozen_loose', label: 'Meia Dúzia (solta)', eggsPerUnit: 6 },
  { id: 'unit_egg', label: 'Ovo (unidade)', eggsPerUnit: 1 },
];

export const COLLECTION_TIME_OPTIONS: CollectionTimeOption[] = [
  { id: 'morning_main', label: 'Manhã (Coleta Principal)', order: 1 },
  { id: 'mid_morning', label: 'Meio da Manhã', order: 2 },
  { id: 'afternoon', label: 'Tarde', order: 3 },
  { id: 'night', label: 'Noite', order: 4 },
  { id: 'extra', label: 'Coleta Extra', order: 5 },
];
...
export const ArchiveBoxIcon = (props: React.SVGProps<SVGSVGElement>) => ( 
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 7.5V6.108c0-1.135.845-2.098 1.976-2.192.353-.026.692-.026 1.032 0 1.13.094 1.976 1.057 1.976 2.192V7.5M8.25 7.5h7.5M8.25 7.5V9c0 .621.504 1.125 1.125 1.125h4.5c.621 0 1.125-.504 1.125-1.125V7.5m0 0h1.125c.621 0 1.125.504 1.125 1.125v10.5c0 .621-.504 1.125-1.125 1.125h-9.75c-.621 0-1.125-.504-1.125-1.125V8.625c0-.621.504-1.125 1.125-1.125H8.25zM5.625 13.5v4.5" />
  </svg>
);
